...
export default function Privacy() {
  return (
    ...
    >
      ...
      <h2>4. Shipping & Tracking (Shiprocket)</h2>
      <p>
      ...
      <h2>5. Cookies</h2>
      <p>We may use cookies/local storage to keep you logged in and improve your browsing experience.</p>

      <h2>6. Data Security</h2>
      <p>We take reasonable measures to protect your data. However, no system is 100% secure.</p>

      <h2>7. Data Retention</h2>
      <p>We retain data as needed to provide services, comply with legal obligations, and resolve disputes.</p>

      <h2>8. Your Rights</h2>
      <p>You can request access, correction, or deletion of your personal data, subject to legal requirements.</p>

      <h2>9. Contact</h2>
      <p>For privacy-related requests, please contact our support team via the Contact page.</p>
    </PolicyLayout>
  )
}
