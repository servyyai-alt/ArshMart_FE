...
export default function Footer() {
  ...
  const socialLinks = [
    { Icon: WhatsAppIcon, href: 'https://wa.me/919367632250', label: 'WhatsApp' },
    { Icon: Instagram, href: 'https://instagram.com/sandhaikart', label: 'Instagram' },
    { Icon: Twitter, href: 'https://twitter.com/sandhaikart', label: 'Twitter' },
    { Icon: Facebook, href: 'https://facebook.com/sandhaikart', label: 'Facebook' },
    { Icon: Youtube, href: 'https://youtube.com/sandhaikart', label: 'Youtube' },
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social, i) => (
                <a
                  ...
                  className="w-9 h-9 glass rounded-xl flex items-center justify-center text-slate-400 hover:text-[#5bb253] hover:border-[#5bb253]/30 transition-all"
                >
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={link.to}>
                  <Link to={link.to} className="text-slate-500 hover:text-[#5bb253] text-sm transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:support@sandhaikart.com" className="text-slate-500 hover:text-[#5bb253] text-sm transition-colors">
        ...
        <div className="border-t border-white/5 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-slate-600 text-sm text-center">
            © {currentYear} Sandhaikart. All rights reserved. Developed by Least Action Company.
          </p>
          <div className="flex items-center gap-6">
            <img src="https://w7.pngwing.com/pngs/93/992/png-transparent-razorpay-logo-tech-companies.png" alt="Razorpay" className="h-7 w-20 opacity-40 hover:opacity-70 transition-opacity" />
